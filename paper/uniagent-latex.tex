...
\author{Ryoto Taga}
\authornote{Personal views of the author; not those of Accenture. This work does not utilize Accenture's knowledge, expertise, or brand.}
...
\begin{enumerate}
  ...
  \item \textbf{A working prototype and end-to-end
    ...
    \url{https://uniagent.dev/}.} on Base Sepolia,
...
deployment at \url{https://uniagent.dev/}. The web application
